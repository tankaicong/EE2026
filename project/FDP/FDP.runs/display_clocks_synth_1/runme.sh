...
HD_PWD='/media/kc/Data/EE2026/project/FDP/FDP.runs/display_clocks_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log display_clocks.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source display_clocks.tcl
