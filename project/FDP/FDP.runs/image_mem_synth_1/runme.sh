...
HD_PWD='/media/kc/Data/EE2026/project/FDP/FDP.runs/image_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_mem.tcl
