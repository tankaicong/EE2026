...
module Randomised_Canvas(
    ...
    // Clamp to ROI (320x240)
    wire [8:0] r0_x = (r0_x_raw > (9'd319 - r0_w)) ? (9'd319 - r0_w) : r0_x_raw;
    wire [7:0] r0_y = (r0_y_raw > (8'd239 - r0_h)) ? (8'd239 - r0_h) : r0_y_raw;
    wire [8:0] r1_x = (r1_x_raw > (9'd319 - r1_w)) ? (9'd319 - r1_w) : r1_x_raw;
    wire [7:0] r1_y = (r1_y_raw > (8'd239 - r1_h)) ? (8'd239 - r1_h) : r1_y_raw;
    wire [8:0] r2_x = (r2_x_raw > (9'd319 - r2_w)) ? (9'd319 - r2_w) : r2_x_raw;
    wire [7:0] r2_y = (r2_y_raw > (8'd239 - r2_h)) ? (8'd239 - r2_h) : r2_y_raw;
    wire [8:0] r3_x = (r3_x_raw > (9'd319 - r3_w)) ? (9'd319 - r3_w) : r3_x_raw;
    ...
    wire [8:0] c0_cx = (r0_x_raw > (9'd319 - {3'b000, c0_r})) ? (9'd319 - {3'b000, c0_r}) : r0_x_raw;
    wire [7:0] c0_cy = (r0_y_raw > (8'd239 - {2'b00, c0_r})) ? (8'd239 - {2'b00, c0_r}) : r0_y_raw;
    wire [8:0] c1_cx = (r1_x_raw > (9'd319 - {3'b000, c1_r})) ? (9'd319 - {3'b000, c1_r}) : r1_x_raw;
    wire [7:0] c1_cy = (r1_y_raw > (8'd239 - {2'b00, c1_r})) ? (8'd239 - {2'b00, c1_r}) : r1_y_raw;
    wire [8:0] c2_cx = (r2_x_raw > (9'd319 - {3'b000, c2_r})) ? (9'd319 - {3'b000, c2_r}) : r2_x_raw;
    wire [7:0] c2_cy = (r2_y_raw > (8'd239 - {2'b00, c2_r})) ? (8'd239 - {2'b00, c2_r}) : r2_y_raw;
    wire [8:0] c3_cx = (r3_x_raw > (9'd319 - {3'b000, c3_r})) ? (9'd319 - {3'b000, c3_r}) : r3_x_raw;
