...
// UFDS Settings Overlay (VGA-space pixel overlay + click handling)
// - Draws 5 segment tabs and a return button with fixed coordinates
...
module ufds_settings_overlay (
    ...
    // Box 7: Next setting (594..630, 322..428)

    wire in_box1 = (px >= 10'd33  && px <= 10'd62  && py >= 9'd322 && py <= 9'd428);
    ...
    wire in_box7 = (px >= 10'd594 && px <= 10'd630 && py >= 9'd322 && py <= 9'd428);

    wire mouse_in_box1 = (mouse_x >= 10'd33  && mouse_x <= 10'd62  && mouse_y >= 9'd322 && mouse_y <= 9'd428);
    ...
    // Shifted right to align under new Tab 5 (x ≈ 416..505)
    // Slider track: x 430..600, y 446..450; 4 ticks at 4,16,32,64
    // Two buttons: Area (x 430..480, y 456..470), Proximity (x 490..550, y 456..470)
    wire in_slider_track = (px >= 10'd430 && px <= 10'd600 && py >= 9'd446 && py <= 9'd450);
    wire [9:0] tick_x0 = 10'd440; // 4
    wire [9:0] tick_x1 = 10'd480; // 16
    wire [9:0] tick_x2 = 10'd520; // 32
    wire [9:0] tick_x3 = 10'd560; // 64
    ...
    wire in_btn_area = (px >= 10'd430 && px <= 10'd480 && py >= 9'd456 && py <= 9'd470);
    wire in_btn_prox = (px >= 10'd490 && px <= 10'd550 && py >= 9'd456 && py <= 9'd470);
    wire mouse_in_btn_area = (mouse_x >= 10'd430 && mouse_x <= 10'd480 && mouse_y >= 9'd456 && mouse_y <= 9'd470);
    wire mouse_in_btn_prox = (mouse_x >= 10'd490 && mouse_x <= 10'd550 && mouse_y >= 9'd456 && mouse_y <= 9'd470);
    ...
    // Precomputed border wires (no functions)
    // Thickness 4 for tab boxes, 2 for small buttons
    wire border_box1 = ((px >= 10'd33 && px <= 10'd62 && (py >= 9'd322 && py < 9'd322 + 9'd4)) ||
                        (px >= 10'd33 && px <= 10'd62 && (py <= 9'd428 && py > 9'd428 - 9'd4)) ||
                        (py >= 9'd322 && py <= 9'd428 && (px >= 10'd33 && px < 10'd33 + 10'd4)) ||
                        (py >= 9'd322 && py <= 9'd428 && (px <= 10'd62 && px > 10'd62 - 10'd4)));
    ...
    wire border_box7 = ((px >= 10'd594 && px <= 10'd630 && (py >= 9'd322 && py < 9'd322 + 9'd4)) ||
                        (px >= 10'd594 && px <= 10'd630 && (py <= 9'd428 && py > 9'd428 - 9'd4)) ||
                        (py >= 9'd322 && py <= 9'd428 && (px >= 10'd594 && px < 10'd594 + 10'd4)) ||
                        (py >= 9'd322 && py <= 9'd428 && (px <= 10'd630 && px > 10'd630 - 10'd4)));

    // Panel 4 button borders (Area/Proximity), thickness 2
    wire border_btn_area = ((px >= 10'd430 && px <= 10'd480 && (py >= 9'd456 && py < 9'd456 + 9'd2)) ||
                            (px >= 10'd430 && px <= 10'd480 && (py <= 9'd470 && py > 9'd470 - 9'd2)) ||
                            (py >= 9'd456 && py <= 9'd470 && (px >= 10'd430 && px < 10'd430 + 10'd2)) ||
                            (py >= 9'd456 && py <= 9'd470 && (px <= 10'd480 && px > 10'd480 - 10'd2)));
    wire border_btn_prox = ((px >= 10'd490 && px <= 10'd550 && (py >= 9'd456 && py < 9'd456 + 9'd2)) ||
                            (px >= 10'd490 && px <= 10'd550 && (py <= 9'd470 && py > 9'd470 - 9'd2)) ||
                            (py >= 9'd456 && py <= 9'd470 && (px >= 10'd490 && px < 10'd490 + 10'd2)) ||
                            (py >= 9'd456 && py <= 9'd470 && (px <= 10'd550 && px > 10'd550 - 10'd2)));
    ...
    // Additional colors for panel indicators
    ...
    always @(*) begin
        ...
        if (!settings_active) begin
            ...
            if (mouse_in_box1 && in_box1) begin overlay_en=1; overlay_rgb=CYAN; end
            if (mouse_in_box2 && in_box2) begin overlay_en=1; overlay_rgb=CYAN; end
            if (mouse_in_box3 && in_box3) begin overlay_en=1; overlay_rgb=CYAN; end
            if (mouse_in_box4 && in_box4) begin overlay_en=1; overlay_rgb=CYAN; end
            if (mouse_in_box5 && in_box5) begin overlay_en=1; overlay_rgb=CYAN; end
            if (mouse_in_box6 && in_box6) begin overlay_en=1; overlay_rgb=CYAN; end
            if (mouse_in_box7 && in_box7) begin overlay_en=1; overlay_rgb=CYAN; end

            // Draw tab borders
            if (border_box1) begin overlay_en=1; overlay_rgb=GREY; end
            if (border_box2) begin
                overlay_en = 1; 
                if (tab_idx == 3'd1) overlay_rgb = YELLOW; else overlay_rgb = GREY;
            end
            if (border_box3) begin
                overlay_en = 1; 
                if (tab_idx == 3'd2) overlay_rgb = YELLOW; else overlay_rgb = GREY;
            end
            if (border_box4) begin
                overlay_en = 1; 
                if (tab_idx == 3'd3) overlay_rgb = YELLOW; else overlay_rgb = GREY;
            end
            if (border_box5) begin
                overlay_en = 1; 
                if (tab_idx == 3'd4) overlay_rgb = YELLOW; else overlay_rgb = GREY;
            end
            if (border_box6) begin
                overlay_en = 1; 
                if (tab_idx == 3'd5) overlay_rgb = YELLOW; else overlay_rgb = GREY;
            end
            ...
            if (tab_idx == 3'd5) begin
                if (border_btn_1) begin
                    overlay_en = 1;
                    if (max_boxes_sel==2'b00) overlay_rgb = CYAN; else overlay_rgb = GREY;
                end
                if (border_btn_2) begin
                    overlay_en = 1;
                    if (max_boxes_sel==2'b01) overlay_rgb = CYAN; else overlay_rgb = GREY;
                end
                if (border_btn_3) begin
                    overlay_en = 1;
                    if (max_boxes_sel==2'b10) overlay_rgb = CYAN; else overlay_rgb = GREY;
                end
                if (border_btn_4) begin
                    overlay_en = 1;
                    if (max_boxes_sel==2'b11) overlay_rgb = CYAN; else overlay_rgb = GREY;
                end
            end
        end
    end
