...
HD_PWD='C:/Users/Joshy/EE2026_Basic_TaskP/EE2026_Project/project/individual/taskP/taskP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Task_P.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Task_P.tcl -notrace
