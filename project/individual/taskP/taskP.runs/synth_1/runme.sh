...
HD_PWD='C:/Users/Joshy/EE2026_Basic_TaskP/EE2026_Project/project/individual/taskP/taskP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Task_P.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Task_P.tcl
